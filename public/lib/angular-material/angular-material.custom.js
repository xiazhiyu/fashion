...
angular.module('material.components.input', [
  ...
  .directive('divarea', inputTextareaDirective)
...
function selectDirective($mdUtil, $window){
  return {
    restrict: 'E',
...
/*
    ...
    */
    ...
    if (containerCtrl.input) {
      throw new Error("<md-input-container> can only have *one* <input> or <textarea> or <select> child element!");
    }
    if (!element.attr('id')) {
...
selectDirective.$inject = ["$mdUtil", "$window"];
